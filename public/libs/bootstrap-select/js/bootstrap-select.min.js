            ...
            (Y.prototype = {
                    ...
                    if (this.options.title && !this.multiple) {
                        ...
                        if (s)
                            (this.selectpicker.view.titleOption.className = "bs-title-option"),
                                ...
                                (i = void 0 === P(t.options[t.selectedIndex]).attr("selected") && void 0 === this.$element.data("selected"));
                ...
                render: function () {
                    var e,
                        ...
                        d = !1;
                    if ((r.classList.toggle("bs-placeholder", t.multiple ? !o : !z(i, n)), this.tabIndex(), "static" === this.options.selectedTextFormat)) c = K.text.call(this, { text: this.options.title }, !0);
